...
{
    class ActivityHandler : IActivityHandler
    {
        ...
        private Task LaunchAttributionActionI()
        {
            ...
            return _deviceUtil.RunActionInForeground(() => _config.AttributionChanged.Invoke(null, _attribution));
        }
        ...
        {
            _deviceUtil.PersistObject(AttributionStorageName, (Dictionary<string, object>)AdjustAttribution.ToDictionary(_attribution));
        }
