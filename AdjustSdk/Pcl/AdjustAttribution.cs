...
namespace AdjustSdk
{
    sealed public class AdjustAttribution
    {
        ...
        public static IReadOnlyDictionary<string, object> ToDictionary(AdjustAttribution attribution)
        {
        ...
        public static AdjustAttribution FromDictionary(IReadOnlyDictionary<string, object> attributionObjectMap)
        {
